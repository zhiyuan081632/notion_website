...
const Blog13Page: React.FC = () => {
  ...
  return (
    <>
      <NextSeo
        title="Notion Template AI Blog1-3"
        description="Notion Template AI Websit Blog1-3"
      />
      <chakra.main>
...
const Mission: React.FC<I_BlockProps> = ({ bodyColor }) => {
  ...
  const videoUrl = 'https://www.youtube.com/watch?v=hbxQw4LQwws';
  return (
    <Box>
      <Container maxW="container.lg">
        <Stack spacing={[10, 10, 20]}>
          <VStack textAlign="center">
            ...
            <iframe 
              width="1120" 
              height="630" 
              src="https://www.youtube.com/embed/hbxQw4LQwws?si=nUs6hruEX9Rof1Xr" 
