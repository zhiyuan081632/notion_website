...
import Envato from "@definitions/brands/envato";
        ...
        >
          ...
          >
            <VStack textAlign="center">
              ...
              <Avatar
                as={Box}
                src="/images/avatar-f-2.jpg"
                name="Shelly Barnard"
              />
              <Box>
                <Text fontWeight="semibold">Shelly Barnard</Text>
                <Text fontSize="sm">Senior Product Manager, Acme Inc.</Text>
              </Box>
            </VStack>
            ...
            <Box>
              <Wrap mt="auto" spacing={5} align="center" justify="center">
                <WrapItem>
                  <Logo3 height="32px" width="auto" color="whiteAlpha.800" />
                </WrapItem>
                <WrapItem>
                  <Envato height="24px" width="auto" color="whiteAlpha.800" />
                </WrapItem>
                <WrapItem>
                  <Logo4 height="32px" width="auto" color="whiteAlpha.800" />
                </WrapItem>
              </Wrap>
