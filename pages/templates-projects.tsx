...
const Home: React.FC = () => {
  ...
  return (
    <>
      <NextSeo
        title="Notion Template AI Project"
        description="Notion Template AI Website project template"
      />
      <chakra.main>
        <VStack mb={32} spacing={20}>
          ...
          title="Projects Templates"
            ...
            items={[
              {
                image: "/images/notion/IssueTracker.png",
                title: "Issue Tracker",
                href: "https://skitter-letter-9ce.notion.site/Issue-Tracker-397b9e4ee59e40619d23b23708c5c479",
                
                
              },
              {
                image: "/images/notion/GoalTracker.png",
                title: "Goal Tracker",
                href: "https://uyilodesign.notion.site/uyilodesign/Goals-e8ea7d01c65f4d9bb60eda8f4433505a",
                
                
              },
              {
                image: "/images/notion/EmailSMSProductContentCalendar.png",
                title: "Email/SMS Product Content Calendar",
