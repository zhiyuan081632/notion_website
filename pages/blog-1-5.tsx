...
const Blog15Page: React.FC = () => {
  ...
  return (
    <>
      <NextSeo
        title="Notion Template AI Blog1-5"
        description="Notion Template AI Websit Blog1-5"
      />
      <chakra.main>
      ...
      <Container maxW="container.lg">
        <Stack spacing={[10, 10, 20]}>
          <VStack textAlign="center">
            ...
            <Heading>15 MUST-KNOW Notion tips for Productivity (in 2023)!</Heading>

            <iframe 
              width="1120" 
              height="630" 
              src="https://www.youtube.com/embed/CPYwVRtlxms?si=6--F839EXHN_JyFx" 
