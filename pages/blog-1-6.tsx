...
const Blog16Page: React.FC = () => {
  ...
  return (
    <>
      <NextSeo
        title="Notion Template AI Blog1-6"
        description="Notion Template AI Websit Blog1-6"
      />
      <chakra.main>
      ...
      <Container maxW="container.lg">
        <Stack spacing={[10, 10, 20]}>
          <VStack textAlign="center">
            ...
            <Heading>9 FREE Notion templates that will 10x your productivity!</Heading>

            <iframe 
              width="1120" 
              height="630" 
              src="https://www.youtube.com/embed/-JKiVnf_Xic?si=_yw6gZpOJUyQtRjy" 
