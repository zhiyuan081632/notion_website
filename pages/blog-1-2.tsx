...
const Blog12Page: React.FC = () => {
  ...
  return (
    <>
      <NextSeo
        title="Notion Template AI Blog1-2"
        description="Notion Template AI Websit Blog1-2"
      />
      <chakra.main>
          ...
          >
            ...
            >
              <Image
                ...
                src="/images/notion/CopyTemplate.jpg"
                rounded="md"
      ...
      <Container maxW="container.lg">
        <Stack spacing={[10, 10, 20]}>
          <VStack textAlign="center">
            ...
            <Heading>How to copy a Notion template?</Heading>
